...
const cards: Card[] = [
  ...
  },
  {
    ...
    company: 'Moretti Culinary Creations',
    phone: '(925) 555-0909',
    email: 'luca@moretticulinary.com',
    website: 'https://moretticulinary.com',
    category: 'Restaurant',
  },
  {
    name: 'Dr. Emily Carter',
    title: 'General Dentist',
    company: 'Carter Family Dentistry',
    phone: '(925) 555-1010',
    email: 'emily@carterdentistry.com',
    website: 'https://carterdentistry.com',
    category: 'Health',
  },
  {
    name: 'Sofia Ramirez',
    title: 'Certified Yoga Instructor',
    company: 'Flow Wellness Studio',
    phone: '(925) 555-2020',
    email: 'sofia@flowwellness.com',
    website: 'https://flowwellness.com',
